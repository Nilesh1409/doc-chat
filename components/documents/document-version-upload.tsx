...
export default function DocumentVersionUpload({ documentId, onSuccess }: DocumentVersionUploadProps) {
  const { user } = useAuth()
                  ...
                  <FormControl>
                    <div
                      className={`border-2 border-dashed rounded-lg p-6 text-center cursor-pointer ${
                        selectedFile ? "border-emerald-500 bg-emerald-50" : "border-muted-foreground/25"
                      }`}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Briefly describe the changes made in this version</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
