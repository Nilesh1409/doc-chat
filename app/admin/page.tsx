...
export default function AdminPage() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const [usersResponse, documentsResponse, ingestionResponse] = await Promise.all([
    ...
    return (
      <div className="container py-10">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground mt-1 mb-4">You do not have permission to access the admin panel.</p>
          <Button asChild>
    ...
    <div className="container py-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage users, documents, and system settings</p>
        </div>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center">
                ...
                <div className="text-2xl font-bold">{stats.totalIngestionJobs}</div>
              </div>
            </CardContent>
          </Card>
        </div>
